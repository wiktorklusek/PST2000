...
namespace Comments
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.HelloWorld("Hello World!");
            /* Multiple line comments start with a slash and a star and 
            can coninue for severlas lines until a closing star and 
            slash are encountered */
        }
    }
}